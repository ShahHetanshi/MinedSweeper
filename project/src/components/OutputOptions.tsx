...
const options: OutputOption[] = [
  ...
  },
  {
    ...
    content: 'Watch the generated video reel below:',
    fileType: 'video',
    filePath: '/outputs/reel_output.mp4',
...
const SelectedOutput: React.FC<{ option: OutputOption; onClose: () => void }> = ({
  ...
  const handleViewPptOnline = (event: React.MouseEvent) => {
    ...
    // Replace this with your actual PPT to PDF conversion logic
    // For now, we'll just open the PPT file in a new tab
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-96 relative">
        ...
        <div className="mt-4 flex justify-center">
          ...
          {option.fileType === 'video' && (
            <div>
              <div
                className={`relative w-full ${option.videoSize === '6:19' ? 'aspect-[9/16]' : option.videoSize === '19:6' ? 'aspect-[16/9]' : 'aspect-video'}`}
              >
